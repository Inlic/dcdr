  ...
  <div class="container-fluid background">
    <div class="row mt-3">
      <div class="col-12 offset-md-4 col-md-4 text-center">
        <h1 class="card bg-dark red">The winner is:</h1>
      </div>
    </div>
    <div class="row mt-3 justify-content-center">
      <div class="col-12 col-md-4 text-center">
        <game-component
          class="text-center animate__animated animate__backInDown"
          :gameData="this.winner"
          :totalVotes="room.names.length"
        />
        <div class="card mt-3 d-none d-lg-block" v-if="winner.appid">
          <h1 class="bg-dark red">Have steam?</h1>
          <button
            @click="launchGame()"
            type="button"
            class="btn btn-primary neon blue m-2"
          >
            Launch Game
          </button>
        </div>
    ...
    <div class="row justify-content-center">
      <div
        ...
        class="col-12 col-md-3 text-center my-2 mx-4"
        :key="game.id"
      >
...
export default {
  ...
  computed: {
    games() {
      return this.$store.state.games.sort(function (a, b) {
